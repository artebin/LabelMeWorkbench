 ...
 * KeywordAnalyzerIndexSearchPanel.java - Apr 13, 2010
 */

public class KeywordAnalyzerIndexSearchPanel extends JPanel implements
		ActionListener {
	...
	private String lucene_index_keyword_analyzer_path = LabelMeWorkbenchProperties
	...
	public KeywordAnalyzerIndexSearchPanel() {
		init();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (actionCommand.equals(ACTION_COMMAND_DO_QUERY)) {
			...
			LabelMeLogger.getBrowserLogger().log(Level.INFO,
					"querying with Lucene (KeywordAnalyzer).");

			searcher = new LuceneLabelMeSearcher(
					lucene_index_keyword_analyzer_path, new KeywordAnalyzer());
	...
	public static void main(String[] args) {
		...
		p.add(new KeywordAnalyzerIndexSearchPanel(), BorderLayout.CENTER);
