...
./lib/Galatee-1.49-2011.01.14.jar:\
./lib/commons-vfs-1.0.jar:\
./lib/LIFE-0.15-2011.10.05.jar:\
./LabelMeWorkbench-0.45-2010.07.08.jar"

BDBXML_LIB_PATH=/home/nicolas/apps/dbxml/dbxml-2.5.16/install/lib

#for i586
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:./lib/jai/jai_i586/:${BDBXML_LIB_PATH}
java -cp ${libraries} net.trevize.labelme.browser.LabelMeBrowser

#for amd64
#export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:./lib/jai/jai_amd64/:${BDBXML_LIB_PATH}
#java -cp ${libraries} net.trevize.labelme.browser.LabelMeBrowser

#pure java mode
#export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${BDBXML_LIB_PATH}
#java -cp ${libraries} net.trevize.labelme.browser.LabelMeBrowser
